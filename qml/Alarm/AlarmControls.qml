...
// Alarm panel controls, like Home Assistant's more-info for alarm panels: the
// state, Disarm and Arm buttons, every arm mode the panel supports, and a
// keypad for panels that take a code. Wide enough, the keypad sits beside the
// rest. Shown by the details overlay for alarm_control_panel entities.
Item {
    id: root

    required property string entityId
    readonly property alias alarm: alarmEntity
    ...
    // Room for the keypad beside the rest.
    readonly property real preferredWidth: root.hasCode ? 760 : 480
